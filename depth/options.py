...
class MonodepthOptions:
    def __init__(self):
        ...
        self.parser.add_argument("--height",
                                 default=384,#192 512 384
                                 type=int)
        self.parser.add_argument("--width",
                                 default=384,#640 512 384
                                 type=int)
        ...
        self.parser.add_argument("--weights_init",
                                 ...
                                 default="pretrained",
                                 choices=["pretrained", "scratch"])#scratch：从头开始训练（随机初始化权重）
        ...
        self.parser.add_argument("--data_path",
                                 ...
                                 default="/root/autodl-fs/pythondata/FLsea")
        ...
        self.parser.add_argument("--learning_rate",
                                 type=float,
                                 help="learning rate",
                                 default=8e-5)#2e-6 1e-5 1e-4 8e-5 9e-5
