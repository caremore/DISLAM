...
namespace ORB_SLAM3 {
    ...
    public:
        ...
        // SuperPoint Getter 方法
        std::string spOnnx() { return spOnnx_; }
        std::string netvladOnnx() { return netvladOnnx_; }
        int spnLevels() { return spnLevels_; }
        float spscaleFactor() { return spscaleFactor_; }
        float spscore() { return spscore_; }
        int spnFeatures() { return spnFeatures_; }
        bool spuseCUDA() { return spuseCUDA_ != 0; }  // int 转 bool
    ...
    private:
        ...
        void readSuperPoint(cv::FileStorage& fSettings);
         ...
         */
         // SuperPoint 参数成员变量
        std::string spOnnx_;
        std::string netvladOnnx_;
        int spnLevels_;
        float spscaleFactor_;
        float spscore_;
        int spnFeatures_;
        int spuseCUDA_;
